-- Clean Phase 1 - With Safe Mode Disabled
...
-- Drop Phase 1 columns from meetings (safe method)
...
-- Clean migration records (now safe mode is disabled)
...
SELECT 'Meetings columns:' as Info;
DESCRIBE meetings;
...
SELECT 'Recent migrations:' as Info;
