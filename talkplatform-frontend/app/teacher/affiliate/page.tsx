...
export default function TeacherAffiliatePage() {
  ...
  const loadReferrals = useCallback(async (page: number = 1) => {
    try {
  ...
  const loadEarningsHistory = useCallback(async (period: 'week' | 'month' | 'year' = 'month') => {
    try {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 max-w-7xl">
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-100 dark:from-blue-950/20 dark:to-indigo-950/20 dark:border-blue-800">
        <CardHeader>
          <CardTitle className="text-blue-900 dark:text-blue-100">Your Referral Code</CardTitle>
          <CardDescription className="text-blue-700 dark:text-blue-300">
            Share this code with students to earn 90% revenue from their purchases!
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex gap-4 items-center">
            <code className="flex-1 p-3 bg-white dark:bg-gray-900 rounded border font-mono text-lg text-center font-bold">
                      ...
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (parent && !parent.querySelector('.avatar-fallback')) {
                            ...
                            fallback.className = 'avatar-fallback w-full h-full flex items-center justify-center text-gray-600 dark:text-gray-300 text-sm font-medium';
